...
const typeDefs = gql`
  ...
  type Mutation {
    register(name: String!, email: String!, password: String!, petName: String!, petAge: Int!, petType: String!, petBreed: String, petFavFood: String, petFavActivities: String, petBio: String): Auth
